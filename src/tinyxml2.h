  ...
  public:
    ...
    */
    ...
    /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every
       ...
       interface for TinyXML-2. (Note however it doesn't re-parse the XML for
       the callbacks, so the performance of TinyXML-2 is unchanged by using this
  ...
  public:
    ...
    */
    ...
    /** Convenience function for easy access to the text inside an element.
       ...
       XMLText child and accessing it directly. If the first child of 'this' is
       a XMLText, the GetText() returns the character string of the Text node,
       else null is returned. This is a convenient method for getting the text
